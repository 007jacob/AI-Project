...
class ChatGPTDatabase:
    ...
    def create_table(self, table_name, columns):
        ...
        The columns parameter should be a comma-seperated string of column
        """
        create_table_sq1 = f"CREATE TABLE IF NOT EXISTS {table_name}"
        ...
        def retrieve_records(self, table_name, conditions=None):
            ...
            The conditions parameter should be a string that represents a SQ-
            """
